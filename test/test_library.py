...
class LibraryValidationTests(unittest.TestCase):
    ...
    def test_homepage_has_picker_and_focused_disclosures(self) -> None:
        ...
        self.assertIn('href="assets/styles.css?v=20260909-workflow"', homepage)
        self.assertIn('src="assets/app.js?v=20260909-workflow"', homepage)
        ...
        self.assertIn('id="export-test-plan" disabled>Export CSV</button>', homepage)
