...
class LibraryValidationTests(unittest.TestCase):
    ...
    def test_homepage_has_picker_and_focused_disclosures(self) -> None:
        ...
        self.assertIn('href="assets/styles.css?v=20260910-branding"', homepage)
        self.assertIn('src="assets/app.js?v=20260910-branding"', homepage)
        self.assertIn('class="brand-links" aria-label="CarlasHub social links"', homepage)
        self.assertIn('class="site-footer"', homepage)
        self.assertIn('aria-label="CarlasHub and project links"', homepage)
        self.assertIn('href="https://carlashub.com/" rel="me"', homepage)
        self.assertIn('href="https://uk.linkedin.com/in/carla-goncalves-9a01a5164" rel="me"', homepage)
        self.assertIn('href="https://github.com/CarlasHub" rel="me"', homepage)
        self.assertIn('href="https://github.com/CarlasHub/a11y-test-cases"', homepage)
        self.assertIn("WCAG 2.2</a> contains the normative requirements", homepage)
        self.assertEqual(31, homepage.count("data-test-card"))
        self.assertEqual(31, homepage.count("data-test-criteria"))
        ...
        self.assertEqual(31, homepage.count('aria-label="Include '))
        ...
        self.assertIn('id="export-test-plan" disabled>Export working CSV</button>', homepage)
        self.assertIn('id="import-test-plan" accept=".csv,text/csv"', homepage)
        self.assertIn('id="run-test-plan"', homepage)
        self.assertIn('id="runner-status"', homepage)
        self.assertIn('id="evaluation-report"', homepage)
        self.assertIn('id="download-evaluation-report" disabled', homepage)
